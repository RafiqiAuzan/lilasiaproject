<template>
    ...
    <div class="edit-product">
        ...
        <form @submit.prevent="submitForm" class="edit-product-form">
            ...
            <input class="input-field" v-model="product.category" placeholder="Product Category" />
            <p v-if="errors.category" class="error">{{ errors.category }}</p>
            
            <input class="input-field" v-model="product.image" placeholder="Product Image" />
    ...
    const product = ref({ id: null, name: '', description: '', price: 0, category: '', image: '' });
    const errors = ref({});
    ...
    if (!product.value.category) errorMessages.category = 'Category is required';
